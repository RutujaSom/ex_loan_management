...
frappe.ui.form.on('Member', {
    ...
    refresh(frm) {
        // --- Custom Buttons ---
        // Import new Members
        frm.add_custom_button('Import Member', () => {
...
function open_import_dialog() {
    const d = new frappe.ui.Dialog({
        ...
        primary_action(values) {
            ...
            frappe.call({
                method: "ex_loan_management.excel_loan_management.doctype.member.member.import_loan_members",
                // method: "ex_loan_management.excel_loan_management.doctype.member.member.update_import_members",
...
function update_status(frm, status) {
    frappe.call({
        method: "ex_loan_management.excel_loan_management.doctype.member.member.update_status",
        args: {
